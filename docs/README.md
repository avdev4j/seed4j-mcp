...
If you are an MCP client / agent integrator, start with [clients.md](clients.md) and [tools.md](tools.md). If you are operating the server, start with [configuration.md](configuration.md). If you are contributing code, start with [develop.md](develop.md).
