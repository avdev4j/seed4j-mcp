...
If you are an MCP client / agent integrator, start with [clients.md](clients.md), [tools.md](tools.md), and [resources.md](resources.md). If you are operating the server, start with [configuration.md](configuration.md). If you are contributing code, start with [develop.md](develop.md).
